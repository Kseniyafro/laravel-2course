    ...
    <head>
        ...
        <style>
            *,::after,::before{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}
            ...
            html{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;tab-size:4;font-family
               :Figtree, sans-serif;font-feature-settings:normal}
               ...
               input::placeholder,
               textarea::placeholder{opacity:1;color:#9ca3af}[role=button],
               utton{cursor:pointer}:disabled{cursor:default}
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <footer class="bg-light mt-auto py-3">
         <div class="container text-center">
               <p class="mb-0">Фролова Ксения Михайловна, 241-3210</p>
         </div>
      </footer>
